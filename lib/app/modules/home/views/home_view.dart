...
class _DashboardAdminState extends State<DashboardAdmin> {
  ...
  List<Map> _fragment = [
    ...
    {'title': 'Data Mahasiswa', 'view': MahasiswaView(),'add': () => MahasiswaAddView()},
    {'title': 'Data Dosen', 'view': DosenView(),'add': () => DosenAddView()},
    {'title': 'Data Pegawai', 'view': MahasiswaView(),'add': () => MahasiswaAddView()},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: drawer(),
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 116, 15, 4),
        titleSpacing: 0,
        ...
        children: [
          DrawerHeader(
            decoration: BoxDecoration(
              color: Color.fromARGB(255, 116, 15, 4),
            ),
            child: Column(
